...
var (
	...
	ErrInvalidRoutePriority   = errors.New("invalid SMS route priority")
	ErrDuplicateRoute         = errors.New("duplicate SMS provider route")
	ErrDuplicateRoutePriority = errors.New("duplicate SMS route priority")
