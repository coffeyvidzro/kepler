...
func (checkProvider) ProvisionDomain(context.Context, platformemail.DomainProvisionRequest) ([]platformemail.VerificationRecord, error) {
	return nil, nil
}

func (checkProvider) GetDomainStatus(context.Context, string, string) (platformemail.DomainStatus, error) {
	return platformemail.DomainStatus{}, nil
}

func (checkProvider) DeleteDomain(context.Context, string, string) error { return nil }

type checkDNS bool

func (dns checkDNS) Verify(context.Context, string, platformemail.VerificationRecord) bool {
	return bool(dns)
}
...
func (stub *provisioningStub) RequestProvisioning(context.Context, uuid.UUID, string) (emailtenant.Tenant, error) {
	stub.requests++
